"""
Adapter Tuning (IA³) — Llama 3.2 1B Instruct
Dataset : cybersecurity_lora_dataset.jsonl
Method  : IA³ inserts learned scalar vectors into key/value projections and
          the FFN down-projection. Fewest trainable params (~0.01%).
VRAM    : ~5 GB
"""
...
def main():
    ...
    print(f"IA³ adapter saved → {OUTPUT_DIR}")
